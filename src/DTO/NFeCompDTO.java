...
public class NFeCompDTO{
	//dados iniciais da nota
	private String num;
	private  FornecedorDTO fornece;
	private int serie;
    ...
    ///lista de produtos;
    ArrayList<ProdutoDTO> listProduto = new ArrayList<>();
	...
	public FornecedorDTO getFornece() {
		return fornece;
	}

	public void setFornece(FornecedorDTO fornece) {
	...
	public void setEmitente(EmitenteDTO cliente) {
	...
	public ArrayList<ProdutoDTO> getListProduto() {
		return listProduto;
	}

	public void setListProduto(ArrayList<ProdutoDTO> listProduto) {
