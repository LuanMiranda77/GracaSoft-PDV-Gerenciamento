...
Source: "D:\System Clinica\postgresql-9.4.26-1-windows-x64.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{app}\postgresql-9.4.26-1-windows-x64.exe"; Parameters: --serverport 5433 --locale C --superaccount postgres --superpassword ads54321 --unattendedmodeui minimal --debuglevel 2 --mode unattended; StatusMsg: Aguarde até que a instalação chegue ao fim...
